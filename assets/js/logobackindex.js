...
window.onload = function () {
    // Selecciona el elemento con la clase .background
    const backgroundElement = document.querySelector('.background-logo');

    if (backgroundElement) {
        Particles.init({
            selector: backgroundElement,
            // Resto de la configuración de Particles.js
        });
    }
};
